...
2532+ tests covering all modules, including regression tests for historical bugfixes (`tests/test_regressions.py`) and dedicated tests for abort() override, sweep subcommand, and irreplaceable seeds. Run with:
