...
def _worker_main(
    ...
    cucb: bool = False,
    cusum_ucb: bool = False,
    cusum_ucb_m: int = 30,
    cusum_ucb_epsilon: float = 0.1,
    cusum_ucb_h: float = 40.0,
    cusum_ucb_xi: float = 0.6,
    fewa: bool = False,
    fewa_alpha: float = 0.5,
    fewa_max_window: int = 512,
    ...
    c2ucb: bool = False,
    c2ucb_alpha: float = 1.0,
    c2ucb_lambda: float = 1.0,
    c2ucb_min_out_rounds: float = 30.0,
    ...
    gradient: bool = False,
    gradient_alpha: float = 0.05,
    gradient_temperature: float = 1.0,
    gradient_temp_decay: float = 0.9995,
    gradient_min_temperature: float = 0.05,
    gradient_floor: float = 0.05,
    successive_elim: bool = False,
    successive_elim_delta: float = 0.1,
    successive_elim_min_pulls: int = 3,
    successive_elim_reopen: int = 0,
    op_katz: bool = False,
    op_katz_alpha_fraction: float = 0.85,
    op_tang: bool = False,
    op_tang_rank: int = 10,
    ...
    entropy_gradient_decay: float = 0.98,
    ...
    fuzzer = Fuzzer(
        ...
        cucb=cucb,
        cusum_ucb=cusum_ucb,
        cusum_ucb_m=cusum_ucb_m,
        cusum_ucb_epsilon=cusum_ucb_epsilon,
        cusum_ucb_h=cusum_ucb_h,
        cusum_ucb_xi=cusum_ucb_xi,
        fewa=fewa,
        fewa_alpha=fewa_alpha,
        fewa_max_window=fewa_max_window,
        ...
        gradient_temp_decay=gradient_temp_decay,
        gradient_min_temperature=gradient_min_temperature,
        gradient_floor=gradient_floor,
        successive_elim=successive_elim,
        successive_elim_delta=successive_elim_delta,
        successive_elim_min_pulls=successive_elim_min_pulls,
        successive_elim_reopen=successive_elim_reopen,
        op_katz=op_katz,
        op_katz_alpha_fraction=op_katz_alpha_fraction,
        op_tang=op_tang,
        ...
        shaped_reward_floor=shaped_reward_floor,
        invasion=invasion,
        garch=garch,
        continuum=continuum,
        ...
        entropy_gradient_decay=entropy_gradient_decay,
