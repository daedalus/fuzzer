...
class Grammar:
    ...
    def __init__(self, seed=None, boltzmann_mutate: bool = False):
        ...
        # recursive descent -- see generate()'s docstring and
        # docs/handover/handover_trees.md §5/§7.4 for the bias this corrects.
        # Default off: P2-2 of handover_generators_2026-09-20.md flags this
        # as shipped-but-unwired pending a G0 A/B, not a known win.
        self.boltzmann_mutate = boltzmann_mutate
    ...
    def _mutate_extend(self, data: bytes, max_len: int) -> bytes:
        ...
        extra = self.generate(max_len=64, boltzmann=self.boltzmann_mutate, target_size=64)
    ...
    def _mutate_insert(self, data: bytes, max_len: int) -> bytes:
        ...
        fragment = self.generate(max_len=32, boltzmann=self.boltzmann_mutate, target_size=32)
    ...
    def _mutate_replace_section(self, data: bytes, max_len: int) -> bytes:
        ...
        span = end - start
        replacement = self.generate(max_len=span, boltzmann=self.boltzmann_mutate, target_size=span)
