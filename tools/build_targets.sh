...
build_simple_targets() {
    ...
    if [ -n "$ffmpeg_root" ]; then
        ...
        FFMPEG_LIBS="$ffmpeg_root/libavformat/libavformat.a $ffmpeg_root/libavcodec/libavcodec.a $ffmpeg_root/libavutil/libavutil.a $ffmpeg_root/libswresample/libswresample.a -lm -llzma -latomic -lX11 -lz -lbz2 $(ffmpeg_extralibs "$ffmpeg_root")"
...
build_simple_so_targets() {
    ...
    if [ -f "$VENDOR_FFMPEG_A" ]; then
        FFMPEG_LIBS="$ffmpeg_vendor_dir/libavformat/libavformat.a $ffmpeg_vendor_dir/libavcodec/libavcodec.a $ffmpeg_vendor_dir/libavutil/libavutil.a $ffmpeg_vendor_dir/libswresample/libswresample.a -lm -llzma -latomic -lX11 -lz -lbz2 $(ffmpeg_extralibs "$ffmpeg_vendor_dir")"
